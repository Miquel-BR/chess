...
<ul class="breadcrumbs first">
    <li><a href="#">Energy Direct Use Tank</a></li>
...
<div class="grid_16 widget first">
	...
	<form name="validacio" method="POST" action="ResultDirectUseTank.php?t=Graphics&projh=<?php echo $projh;?>" id="validacio">

	<!--<td><img src="grafico_barra4.php?<?php echo "varTemp1=$vserTemp1&varTemp2=$vserTemp2";?>" alt="" border="0"></td></tr>-->
	<td><img src="grafico_barra6.php?<?php echo "nomarchivo=$nomarchivoDT";?>" alt="" border="0"></td></tr>
