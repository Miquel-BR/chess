...
<div id="popup_window_id_CD1" class="popup_window_css"><table class="popup_window_css"><tr><td class="popup_window_css"><div class="popup_window_css_head"><img src="/images/close.gif" alt="" width="9" height="9" />Info</div><div class="popup_window_css_body">The green and red colors on the buttons indicate whether the related information necessary for the calculation is complete or not. <br>Green would indicate that there is sufficient information <br>Red indicates that it is necessary to complete the information. Click the button, if it's not a ref button, and complete all the data<br>To pass the next screen it is necessary to complete all the necessary data at which time the NEXT button will change to green and we can continue on the next screen by clicking on it. </div><div class="popup_window_css_foot"><a href="http://www.php-development.ru/javascripts/popup-window.php" title="Powered by PHPDevel Popup Window | PHPDevel web scripts collection"><img src="/images/about.gif" alt="" width="6" height="6" /></a></div></td></tr></table></div>
<div id="popup_window_id_CD2" class="popup_window_css"><table class="popup_window_css"><tr><td class="popup_window_css"><div class="popup_window_css_head"><img src="/images/close.gif" alt="" width="9" height="9" />Info</div><div class="popup_window_css_body">Considering the difficulty of entering the complete information of the external conditions for a given location, the Database has complete information for some of these locations.<br>This translates to the reference data buttons in green (Radiation Ref, Air Temperature Ref, Ground Temperature Ref, Irradiation Ref). <br>If we click on one of these buttons, a copy of the information from the locality data will be made to be used in our particular project without the need to enter all the data one by one. <br>ATTENTION: the copy can take a few moments until the related button of the data turns green indicating that the transfer of information has been made.</div><div class="popup_window_css_foot"><a href="http://www.php-development.ru/javascripts/popup-window.php" title="Powered by PHPDevel Popup Window | PHPDevel web scripts collection"><img src="/images/about.gif" alt="" width="6" height="6" /></a></div></td></tr></table></div>
<!--
<div id="popup_window_id_CD3" class="popup_window_css"><table class="popup_window_css"><tr><td class="popup_window_css"><div class="popup_window_css_head"><img src="/images/close.gif" alt="" width="9" height="9" />Info</div><div class="popup_window_css_body"></div><div class="popup_window_css_foot"><a href="http://www.php-development.ru/javascripts/popup-window.php" title="Powered by PHPDevel Popup Window | PHPDevel web scripts collection"><img src="/images/about.gif" alt="" width="6" height="6" /></a></div></td></tr></table></div>
<div id="popup_window_id_CD4" class="popup_window_css"><table class="popup_window_css"><tr><td class="popup_window_css"><div class="popup_window_css_head"><img src="/images/close.gif" alt="" width="9" height="9" />Info</div><div class="popup_window_css_body"></div><div class="popup_window_css_foot"><a href="http://www.php-development.ru/javascripts/popup-window.php" title="Powered by PHPDevel Popup Window | PHPDevel web scripts collection"><img src="/images/about.gif" alt="" width="6" height="6" /></a></div></td></tr></table></div>
...
<br><br>
						...
						<div  style="width:400px;">About the color of the buttons:&nbsp;&nbsp;&nbsp;<input type=image src="images/info.png" width="20" height="20"  onclick="popup_window_show('#popup_window_id_CD1', { pos : 'tag-top-right', parent : this, x : 0, y : 0, width : 'auto' ,hight:'auto'}); return false;">&nbsp;&nbsp;&nbsp; About the Ref buttons:&nbsp;&nbsp;&nbsp;<input type=image src="images/info.png" width="20" height="20"  onclick="popup_window_show('#popup_window_id_CD2', { pos : 'tag-top-right', parent : this, x : 0, y : 0, width : 'auto' }); return false;">
						</div>
						<br>
