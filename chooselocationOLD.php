...
<br><br>
						...
						<input type="hidden" name="dis3" id="dis3">
						<input type="hidden" name="dis8" id="dis8">
	...
	for (var j=0;j<arrayAux.length;j++)
			...
			if(arrayAux[j]['localitat']==jaux && arrayAux[j]['tipusdis']==1)
				...
				if(arrayAux[j]['discompleta']==0)
					...
					jaux1=1;
					//$("#color1").html("red");
					$("#radiation").removeClass();
					$("#radiation").addClass("btn red");
					}
				else
					{
					jaux1=0;
			...
			if(arrayAux[j]['localitat']==jaux && arrayAux[j]['tipusdis']==3)
				...
				if(arrayAux[j]['discompleta']==0)
					...
					jaux3=1;
					//$("#color3").html("red");
					$("#airground").removeClass();
					$("#airground").addClass("btn red");
					}
				else
					{
					jaux3=0;
			...
			if(arrayAux[j]['localitat']==jaux && arrayAux[j]['tipusdis']==8)
				...
				if(arrayAux[j]['discompleta']==0)
					...
					jaux8=1;
					//$("#color1").html("red");
					$("#irradiation").removeClass();
					$("#irradiation").addClass("btn red");
					}
				else
					{
					jaux8=0;
					//$("#color1").html("green");
					$("#irradiation").removeClass();
					$("#irradiation").addClass("btn green");
					}
				$("#dis8").val(jaux5);
				}
			}
