...
for ($year=1;$year<=2;$year++)
	...
	for($hora=1;$hora<=8760;$hora++)
		...
		$Pdistr=$mdt*$Celiq*($Tdte+$Ta1e-$Tdts-$Ta1);
		...
		$vResultCapSolar[$index]=array("Rad"=>$vRad[$hora]['valor'],"Irr"=>$vIrr[$hora]['valor'],"Text"=>$vText[$hora]['valor'],"mst"=>$mst,"Tsts"=>$Tsts,"Tste"=>$Tste,"mst1"=>$mst1,"Tst1s"=>$Tst1s,"Tst1e"=>$Ta1,"mst2"=>$mst,"Tst2s"=>$Tst2s,"Tst2e"=>$Ta2,"Tcol"=>$Tcol,"Rend"=>$Rend,"Est"=>$Est,"Ps"=>$Ps);
	...
	for ($i=0;$i<$index;$i++)
		...
		$linea="$iii"."|".$hora."|".$dia."|".$mes."|".$year2."|".$aux1."|".$aux2."|".$aux3."|".$aux4."|".$aux5."|".$aux6."|".$aux7."|".$aux8."|".$aux9."|".$aux10."|".$aux11."|".$aux12."|".$aux13."|".$aux14."|".$aux15."|".$aux16."|".$aux17."|".$aux18."|".$aux19."|".$aux20."|".$aux21."|".$aux22."|".$aux23."|".$aux24."|".$aux25."|".$aux26."|".$aux27."|".$aux28."|".$aux29."|".$aux36."|".$aux37."|".$aux38."|".$aux39."|".$aux42."|".$aux43."|".$aux44."|".$aux45."|".$aux46."|".$aux47."|".$aux48."|".$aux49;
