...
if(isset($_GET['totalinvesthidden'])){$totalinvesthidden=$_GET['totalinvesthidden'];}
else{if(isset($_POST['totalinvesthidden'])){$totalinvesthidden=$_POST['totalinvesthidden'];}}
...
$projecte=$projh;
$opcion=$_POST['addbtn'];
//echo "<br>$opcion,$projecte,$totalinvesthidden,$invest,$mantenance,$ratioSP,$ratioSTO,$ratioHP,$ratioDTU,$ratioDS,$ratioGB";
if(isset($_POST['addbtn'])){
	//insertar suma final inversión y sumafinal de mantenimiento
	//echo "$projecte,$invest,$mantenance";
    $retorno=projectes::addpressupost($projecte,$totalinvesthidden,$mantenance,$ratioSP,$ratioSTO,$ratioHP,$ratioDTU,$ratioDS,$ratioGB);
	...
	<table>
		<tr></tr>
         <tr>
			...
			<input type="hidden" name="totalinvesthidden" id="totalinvesthidden" value="<?php echo $totalinvest; ?>">
