...
<div id="popup_window_id_STO3" class="popup_window_css"><table class="popup_window_css"><tr><td class="popup_window_css"><div class="popup_window_css_head"><img src="/images/close.gif" alt="" width="9" height="9" />Info</div><div class="popup_window_css_body">-          The seasonal system volume depends on many factors (climate, demand profile, temperatures of operation and others). As a first value try with 2 m&#179; of seasonal system for each m&#178; of solar panel.</div><div class="popup_window_css_foot"><a href="http://www.php-development.ru/javascripts/popup-window.php" title="Powered by PHPDevel Popup Window | PHPDevel web scripts collection"><img src="/images/about.gif" alt="" width="6" height="6" /></a></div></td></tr></table></div>
<div id="popup_window_id_STO4" class="popup_window_css"><table class="popup_window_css"><tr><td class="popup_window_css"><div class="popup_window_css_head"><img src="/images/close.gif" alt="" width="9" height="9" />Info</div><div class="popup_window_css_body">Minimal temp. >50&#176; .</div><div class="popup_window_css_foot"><a href="http://www.php-development.ru/javascripts/popup-window.php" title="Powered by PHPDevel Popup Window | PHPDevel web scripts collection"><img src="/images/about.gif" alt="" width="6" height="6" /></a></div></td></tr></table></div>
...
-->
	...
	<pre style="width:600px; height:160px;">
		...
		<label>Volume:   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" name="volume" id="volume" style="width:60px;" value="<?php echo round($w_volume,0); ?>"><label>&nbsp;&nbsp;&nbsp; m&#179;   &nbsp;&nbsp;&nbsp;</label><input type=image src="images/info.png" width="20" height="20"  onclick="popup_window_show('#popup_window_id_STO3', { pos : 'tag-top-right', parent : this, x : 0, y : 0, width : 'auto' }); return false;">
	...
	<table>
		...
		<tr><td width="100"><label>Density:</label></td><td><input type="text" name="density" id="density" style="width:80px;" value="<?php echo round($densitatmaterial,2);?>"> <label>Kg/m&#179;</label></td><td><label>Min. Temperature</label></td><td width="100"><input type="text" name="mintemp" id="mintemp" style="width:50px;" value="<?php echo $mintemp;?>"> <label>&#176C </label> <!--<input type=image src="images/info.png" width="20" height="20"  onclick="popup_window_show('#popup_window_id_STO4', { pos : 'tag-top-right', parent : this, x : 0, y : 0, width : 'auto' }); return false;">--></td>

		</tr>
		<tr><td width="100"><label>Heat Capacity:</label></td><td width="100"><input type="text" name="heatcapacity" id="heatcapacity" style="width:80px;" value="<?php echo round($capacitatcalormaterial,2);?>"> <label>Wh/Kg&#176C</label></td><td width="100"><label>Tank Surface:</label></td><td width="100"><input type="text" name="tanksurface" id="tanksurface" style="width:50px;" value="<?php echo round($tanksurface,0);?>"> <label>m&#178;</label></td>

		</tr>
		<tr><td width="100"></td><td width="100"></td><td width="100"><label>Heat Transfer (U):</label></td><td><input type="text" name="heattransfer" id="heattransfer" style="width:50px;" value="<?php echo round($heattransfer,2);?>"> <label>W/&#176C·m&#178;</label></td>
		</tr>
